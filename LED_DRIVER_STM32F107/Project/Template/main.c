...
void RCC_Configuration(void)
{
  ...
  RCC_APB1PeriphClockCmd(RCC_APB1Periph_UART4|RCC_APB1Periph_TIM2|RCC_APB1Periph_TIM4|RCC_APB1Periph_TIM3|RCC_APB1Periph_USART2|RCC_APB1Periph_CAN1|RCC_APB1Periph_CAN2,ENABLE);
